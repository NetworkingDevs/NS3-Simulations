/**
 * The purpose of this file is to demonstrate 'RandomWalk2dMobilityModule'
 * You can consider this code as an example for setting up above mentioned
 * Mobility Module in your code.
 * 
 * Major LOC: 54-to-70
 *
 **/   
